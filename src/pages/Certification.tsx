...
import { _addCertification } from '../redux/actions/certification.action'

const Certification = () => {
    const { marchand } = useSelector((state: ROOT_REDUCER_TYPE) => state.marchand)
    const { loadingCertification } = useSelector((state: ROOT_REDUCER_TYPE) => state.certification)
    const dispatch = useDispatch<any>()

    const [acceptCondition, setAcceptCondition] = useState(false)

    const handleValidate = () => {
        acceptCondition && dispatch(_addCertification({ storeId: marchand?.store.id as string }, setAcceptCondition))
    }
            ...
            {loadingCertification ?
                ...
                <div className='certification_container'>
                    ...
                    <label htmlFor='condition_utilisation' className='condition_utilisation_container'>
                        <input type='checkbox' name='condition_utilisation' id='condition_utilisation' onChange={e => setAcceptCondition(e.target.checked)} className='condition_utilisation' />
